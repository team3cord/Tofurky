...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
        ...
        <div class="footer-social">
            <ul>
                <li><a class="pin-wt" href="http://www.pinterest.com/tofurky/" target="_blank">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="591.2 91.3 19.2 19.2" style="enable-background:new 591.2 91.3 19.2 19.2;" xml:space="preserve"><style type="text/css"></style><path class="svg-pin" d="M600.9,91.3c-5.3,0-9.6,4.4-9.6,9.7c0,4,2.3,7.4,5.8,8.9c0-0.7,0-1.5,0.2-2.3c0.2-0.8,1.2-5.3,1.2-5.3
	...
	C610.5,95.7,606.2,91.3,600.9,91.3"/></svg>
                ...
                <li><a class="fb-wt" href="https://www.facebook.com/TofurkyFan" target="_blank">
...
<style type="text/css"></style>
                            <path class="svg-fb" d="M867.4,480.6H863V471h-2.2v-3.2h2.2v-2c0-2.7,1.2-4.3,4.8-4.3h2.9v3.3H869c-1.3,0-1.5,0.5-1.5,1.3v1.6h3.4
	l-0.3,3.3h-2.9v9.6H867.4L867.4,480.6L867.4,480.6z"/>
                ...
                <li class="twt-wt"><a href="https://twitter.com/@tofurky" target="_blank">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="587.2 149.2 23.2 19.1" style="enable-background:new 587.2 149.2 23.2 19.1;" xml:space="preserve">
<style type="text/css"></style>
                            <path class="svg-twt" d="M594.6,168.3c-2.7,0-5.3-0.7-7.4-2.2c0.4,0,0.7,0.1,1.1,0.1c2.2,0,4.3-0.7,5.9-2.1c-2.1,0-3.8-1.5-4.4-3.4
	...
	C608.2,160.8,603.3,168.3,594.6,168.3"/>
                ...
                <li><a class="inst-wt" href="https://instagram.com/the_tofurky_company/" target="_blank">
...
<style type="text/css">
                            ...
                            <path class="svg-inst" d="M608.2,88.5h-1.7c0.1,0.5,0.2,1,0.2,1.5c0,3.2-2.6,5.8-5.9,5.8S595,93.2,595,90c0-0.5,0.1-1,0.2-1.5h-1.7v8.1
	...
	c0-1.2,1-2.2,2.2-2.2h14.7c1.2,0,2.2,1,2.2,2.2v14.7C610.4,98.6,609.4,99.6,608.2,99.6"/>
                ...
                <li><a class="rss-wt" href="http://blog.tofurky.com/rss">
...
<style type="text/css">
                            ...
                            <g class="hv-rss">
                                <ellipse class="svg-rss" cx="501.8" cy="198" rx="2.5" ry="2.5"/>
                                <path class="svg-rss" d="M499.2,191.6c2.4,0,4.6,0.9,6.3,2.6s2.6,4,2.6,6.4h3.6c0-7-5.6-12.7-12.6-12.7V191.6z"/>
                                <path class="svg-rss" d="M499.2,185c8.5,0,15.4,7,15.4,15.6h3.6c0-10.7-8.6-19.3-19-19.3V185z"/>
                            </g>
</svg>
                </a></li>
            </ul>

/*
 ...
 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2c72bd";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=1,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"MuseoSlab-300",url:wfpath+"2C72BD_0"+suffix+"_0."+webfontType},{fontFamily:"MuseoSlab-300Italic",url:wfpath+"2C72BD_1"+suffix+"_0."+webfontType},{fontFamily:"MuseoSlab-100Italic",url:wfpath+"2C72BD_2"+suffix+"_0."+webfontType},{fontFamily:"ProximaNova-LightIt",url:wfpath+"2C72BD_3"+suffix+"_0."+webfontType},{fontFamily:"ProximaNova-Light",url:wfpath+"2C72BD_4"+suffix+"_0."+webfontType},{fontFamily:"ProximaNova-Regular",url:wfpath+"2C72BD_5"+suffix+"_0."+webfontType},{fontFamily:"ProximaNova-Bold",
url:wfpath+"2C72BD_6"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+fonts[i].fontWeight+";");fonts[i].fontStyle&&(css+="font-style: "+fonts[i].fontStyle+";");css+="}"}
